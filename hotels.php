  ...
  <div class = "cards">
    ...
    <div class = "card1">
      <form action="/action_page.php">
        <input type="checkbox" id="Budget1" name="Budget1" value="5000">
        <label for="vehicle1"> BDT 0 - BDT 5000</label><br>
        <input type="checkbox" id="Budget2" name="Budget2" value="10000">
        <label for="vehicle2"> BDT 5000 - BDT 10000</label><br>
        <input type="checkbox" id="Budget3" name="Budget3" value="15000">
        <label for="vehicle3"> BDT 10000 - BDT 15000</label><br>
        <input type="checkbox" id="Budget4" name="Budget4" value="100000">
        ...
        <input type="checkbox" id="score3" name="score3" value="7">
        <label for="vehicle3"> Good - 7+</label><br>
        <input type="checkbox" id="score4" name="score4" value="6">
        <label for="vehicle3"> Average - 6+</label><br>
        <input type="checkbox" id="Breakfast" name="Breakfast" value="Breakfast Included">
        ...
        <input type="checkbox" id="Wifi" name="Wifi" value="Free WiFi">
...
<div id="hotels">
    <div id="hotelall">
      ...
      <span id="hotel_Name">Radisson Blu Dhaka Water Garden
        ...
        <br><span id="rooms">Rooms left: 3</span></span>
        <br>
        <span id="discount">30% Discount Available</span>
        <br>
        <span id="stay_info">3 nights,2 adults,1 children,1 room</span>
        <br>
